    ...
    const fetchData = async () => {
      try {
        ...
        if (response.status === 200) {
          ...
          console.log("About Us from response:", settingsData.about_us); // Logs correct data

          // Update states
          setDollarValue(settingsData.dollar_price);
          setHeroImages(settingsData.hero);
          setSettings(settingsData); // Entire settings object
          setAboutUs(settingsData.about_us); // Directly update about_us
